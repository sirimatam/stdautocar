...
pg_query($db,"CREATE TABLE Customer1 (cus_id vachar(5) NOT NULL PRIMARY KEY, cus_name vachar(30) NOT NULL, cus_lastname vachar(30) NOT NULL, cus_pic vachar(30) NOT NULL)");
