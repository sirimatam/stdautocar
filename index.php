...
//	    'messages' => [['type' => 'flex', 'contents' => [['type' => 'bubble', 'body' => [['type' => 'box', 'layout' => 'vertical', 'contents' => [['type' => 'button', 'style' => 'primary', 'height' => 'sm', 'action' => [['type' => 'uri', 'label' => 'add', 'uri' => "https://developers.line.me"]]]]]]]]]]];
   $data = ['type' => 'template', 'altText' => 'this is a button template', 'template' => ['type' => 'buttons', 'actions' => ['type'=> 'message', 'label' => 'Action1' , 'text' => 'click success ka'],'thumbnailImageUrl' => 'http://images6.fanpop.com/image/photos/38600000/Adventure-Time-cartoon-network-38672283-1600-900.jpg', 'title' => 'car', 'text' => 'mini']];
